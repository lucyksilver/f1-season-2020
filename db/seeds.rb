...
RaceResult.create!(race: one, driver: hamilton, position: '1')
...
RaceResult.create!(race: two, driver: verst, position: '2')
...
RaceResult.create!(race: three, driver: bottas, position: '1')
